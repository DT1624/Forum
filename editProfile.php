<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if(!password_verify($oldPass, $user['password'])) {
            //$_SESSION['message'] = $oldPass . ' '. $user['password'];
            ...
            if(password_verify($newPass, $user['password'])) {
                $_SESSION['message'] = "Mật khẩu mới phải khác mật khẩu gần đây của bạn!";
                header("Location: editProfile.php?userId=$userID");
                exit();
            } else {
                if(strlen($newPass) < 6) {
...
<body>
    ...
    <div style="align-items: center;">
        ...
        <form action="editProfile.php?userId=<?php echo $userID ?>" method="post" enctype="multipart/form-data">
            ...
            <label style="width:auto; background-color: #F67C60" onclick="document.getElementById('file').click();">Choose File</label>
