...
<head>
  ...
  <link rel="icon" type="image/x-icon"
    href="https://cdn.haitrieu.com/wp-content/uploads/2021/10/Logo-DH-Cong-Nghe-UET.png">
  <style>
    html,
    body,
    h1,
...
<body class="w3-theme-l5">
  ...
  <div class="w3-top">
    <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
      ...
      <a href="forum.php?category=recently" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"
        onclick="clickLogo()"><i class="fa fa-home w3-margin-right"></i>Logo</a>
      ...
      <a href="profile.php?userId=<?php echo $userID ?>"
        class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" style="height:auto"
        title="My Account" onclick="clickProfile()">
      ...
      <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white w3-right"
        title="Messages"><i class="fa fa-sign-out"></i></a>
    </div>
  </div>
